...
export default function About() {
  return (
    <div>
    <main className="mx-4  min-h-screen overflow-y-auto min-w-xl px-2 py-5 overflow-hidden">

     <h1 className=' text-[#954D4B] text-6xl italic font-serif text-center'>
      Behind the Brand
     </h1>
    ...
    <img src="https://kyliecosmetics.com/cdn/shop/files/v1_about_us_cosmetics_desktop_58546ffe-65e0-47a2-a3e3-3fba048f5169.jpg?crop=center&height=577&v=1773356609&width=1920"
     ...
     <p className="text-justify italic text-xl px-25 py-8 text-[#954D4B]">
      ...
      everything is clean, vegan, and made with ingredients that are good for your skin, but i made sure we didn’t sacrifice quality, pigmentation, or performance.

      and the best is yet to come! i’m working on some amazing new launches that i can’t wait to share with you.
      <br/>

      xo, Jojo 💕 <br/>

      make sure you follow @satinbeauty to stay updated.
     </p>
